              ...
              <div class="portfolio-wrap">
                ...
                @foreach ($portofolio as $portofolio)
                    <div class="col-lg-4 col-md-6 portfolio-item filter-{{ $portofolio->category }}">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('storage/portofolio/' . $portofolio->image) }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>{{ $portofolio->title }}</h4>
                                <div class="portfolio-links">
                                    <a href="{{ $portofolio->detail ? asset('storage/portofolio/' . $portofolio->detail) : asset('template/assets/img/portfolio/portfolio-2.jpg') }}"
